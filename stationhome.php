    ...
    <body>
        ...
        <div class="container">
            <div class="welcome-section">
                <h2>Welcome, <?php echo ucfirst($_SESSION['username']); ?> Police Station</h2>
                <p>Here you can manage and control complaints Cyber Crime System.</p>
            </div>

            <div class="features">
                <div class="card">
                    <h3>View Complaints</h3>
                    <p>Here you can view all registered Complaints in Cyber Crime System.</p>
                    <a href="stationcase.php?usertype=2">Click Here</a>
                </div>

                <div class="card">
                    <h3>View User Details</h3>
                    <p>View detailed information about complainant and track their complaints.</p>
                    <a href="allusers.php?usertype=2">Click Here</a>
                </div>

                <div class="card">
                    <h3>Complaint Status Update</h3>
                    <p>Monitor and update the status of complaints filed in this system.</p>
                    <a href="casestatusupdate.php">Click Here</a>
                </div>
